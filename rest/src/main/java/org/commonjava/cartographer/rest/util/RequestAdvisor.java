...
import org.commonjava.cartographer.graph.filter.ExtensionFilter;
import org.commonjava.cartographer.graph.filter.OrFilter;
import org.commonjava.cartographer.graph.filter.ParentFilter;
import org.commonjava.cartographer.graph.filter.PluginRuntimeFilter;
...
import static org.commonjava.propulsor.deploy.undertow.util.HttpUtils.getBooleanParamWithDefault;
import static org.commonjava.propulsor.deploy.undertow.util.HttpUtils.getFirstParameterValue;
import static org.commonjava.propulsor.deploy.undertow.util.HttpUtils.getLongParamWithDefault;
import static org.commonjava.propulsor.deploy.undertow.util.HttpUtils.getStringParamWithDefault;
...
public class RequestAdvisor
{
    ...
    {
        ProjectRelationshipFilter filter = presetSelector.getPresetFilter( getFirstParameterValue( params, "preset" ),
                                                                           config.getDefaultWebFilterPreset(),
                                                                           presetParameters );
        ...
        {
            filters.add( new DependencyFilter(
                    DependencyScope.getScope( getStringParamWithDefault( params, "s", "runtime" ) ) ) );
        }
