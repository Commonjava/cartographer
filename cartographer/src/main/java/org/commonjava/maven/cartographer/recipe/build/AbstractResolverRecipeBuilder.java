...
public abstract class AbstractResolverRecipeBuilder<O extends ResolverRecipeOwner<O, R>, T extends AbstractResolverRecipeBuilder<O, T, R>, R extends AbstractResolverRecipe>
{

    public static class StandaloneRecipeOwner<R extends AbstractResolverRecipe>
        implements ResolverRecipeOwner<StandaloneRecipeOwner<R>, R>
    {
        ...
        @Override
        public StandaloneRecipeOwner<R> withResolverRecipe( final R recipe )
        {
            logger.debug( "Got recipe: {}", recipe );
            this.recipe = recipe;
            return this;
        }
    ...
    public AbstractResolverRecipeBuilder( final O owner )
    {
        this.owner = owner;
        self = (T) this;
    }
    ...
    protected void configure( final AbstractResolverRecipe recipe )
    {
    ...
    public O finishRecipe()
    {
        if ( owner != null )
        {
            return owner.withResolverRecipe( build() );
        }
