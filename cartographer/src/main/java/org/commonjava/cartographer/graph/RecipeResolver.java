...
public class RecipeResolver
{
        ...
        throws CartoRequestException
    {
        ...
        {
            throw new CartoRequestException( "Failed to graph location from spec: '%s'. Reason: %s", e, spec,
                                          e.getMessage() );
        }
        ...
        throws CartoDataException
    {
        ...
        if ( specs != null )
        {
            for ( final String spec : specs )
            {
                ...
                {
                    throw new CartoDataException( "Failed to graph location from spec: '%s'. Reason: %s", e, spec,
                                                  e.getMessage() );
                }
