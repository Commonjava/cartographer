    ...
    implements CartoDataManager, GraphWorkspaceListener
{
        ...
        throws CartoDataException
    {
        ...
        {
            throw new CartoDataException( "Failed to traverse database for parents of: %s. Reason: %s", e, source,
                                          e.getMessage() );
        }
    ...
    public void addMetadata( final ProjectVersionRef ref, final Map<String, String> metadata )
    {
        ...
        graphs.addMetadata( ref, metadata );
    }
        ...
        throws CartoDataException
    {
        ...
        if ( md == null )
        {
            ...
            if ( md == null )
            {
                logger.error( "Cannot retrieve metadata for: %s", ref );
                return;
            }
        }
        ...
        throws CartoDataException
    {
        ...
        logger.info( "Looking for paths to missing projects: %s in network: %s filtered by: %s", join( leaves, ", " ),
                     web, filter );
