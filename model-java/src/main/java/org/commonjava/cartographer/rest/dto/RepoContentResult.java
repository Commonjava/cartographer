    ...
    implements Iterable<ProjectVersionRef>
{
    ...
    private Map<String, String> repoUrls;
    ...
    public Map<String, String> getRepoUrls()
    {
        return repoUrls;
    }

    public void setRepoUrls( Map<String, String> repoUrls )
    {
        this.repoUrls = repoUrls;
    }

    public synchronized void addRepoUrl( String key, String url )
    {
        if ( repoUrls == null )
        {
    ...
    public String getRepoUrl( String key )
    {
