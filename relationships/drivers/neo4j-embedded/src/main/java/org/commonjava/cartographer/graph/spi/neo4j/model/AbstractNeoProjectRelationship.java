    ...
    implements ProjectRelationship<I, T>
{
    ...
    public Set<URI> getSources()
    {
        ...
        Set<URI> srcs = Conversions.getURISetProperty( Conversions.SOURCE_URI, rel, UNKNOWN_SOURCE_URI );
    ...
    {
        URI pl = Conversions.getURIProperty( Conversions.POM_LOCATION_URI, rel, POM_ROOT_URI );
        if ( pl != null )
        {
            return pl;
        }
